...
<div class="box-common box-info">
<p>また、たとえ `2^64` という小さく<strong>見える</strong>数値であったとしても、「hmac の認証タグを  `2^256` 通り生成する場合に秘密鍵を固定したとしても毎秒 1 ギガビットのペースで 25 万年かかる」と [HMAC RFC 2014](https://www.ietf.org/rfc/rfc2104.txt) に記載がありました。この話は趣旨的にはややずれるものではあるにせよ、2 の 128 乗や 256 乗という値の十分さを理解する一助にはなるでしょう。</p>
</div>
